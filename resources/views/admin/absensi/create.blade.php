                    ...
                    <div class="form-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" class="form-control @error('jam_masuk')
                                is-invalid
                            @enderror" id="jam_masuk" name="jam_masuk" placeholder="Masukan Jam Masuk..." required value="{{ old('jam_masuk') }}">
                            @error('jam_masuk')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="datetime-local" class="form-control @error('jam_keluar')
                                is-invalid
                            @enderror" id="jam_keluar" name="jam_keluar" placeholder="Masukan Jam Keluar..." required value="{{ old('jam_keluar') }}">
                            @error('jam_keluar')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
